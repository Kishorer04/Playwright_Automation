...
// By default it will be 'true'. Changing it to 'false' for executing Hooks1.spec.js
...
// beforeAll() fixture
test.beforeAll(async ({browser})=>{            // All hooks like beforeEach, afterEach, beforeAll, afterAll will not accept 'page' fixture
...
// afterAll() fixture
test.afterAll(async()=>{     // Nothing is given in the brackets since we have got 'page' fixture globally
